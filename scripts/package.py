...
'''
for name in ['stage.sh', 'ram-init.sh', 'target.sh', 'progress.py', 'plan.py', 'grow.sh', 'grow.service', 'status.sh', 'identity.py', 'ram-boot.sh', 'build-rescue.py', 'zbm-install.sh', 'snapshot.sh', 'volume.sh', 'backup.sh', 'priority.py']:
