...
This tested the curl-pipeline installation before publication. The checksum below identifies the tested artifact. The GitHub download URL
was not used in this Droplet run.
